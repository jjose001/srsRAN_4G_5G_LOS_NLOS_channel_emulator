...
public:
  ...
  void set_dl_channel(srsran::channel* dl_channel_); ///< Set DL channel emulator (raw pointer)
...
private:
  ...
  srsran::channel*             dl_channel          = nullptr; ///< DL channel emulator (raw pointer, owned by sync_sa)
};
} // namespace nr
} // namespace srsue
