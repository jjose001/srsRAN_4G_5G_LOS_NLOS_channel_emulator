...
void phy_nr_sa::init_background()
{
  ...
  sync_args.ul_channel_args     = args.ul_channel_args; ///< Pass UL channel emulator arguments
  sync_args.dl_channel_args     = args.dl_channel_args; ///< Pass DL channel emulator arguments
  sync_args.nof_rx_channels     = args.dl.nof_rx_antennas; ///< Use number of RX antennas from DL config
