...
int ue::init(const all_args_t& args_)
{
  ...
  phy_args_nr.ul_channel_args      = args.phy.ul_channel_args; ///< Copy UL channel emulator arguments
  phy_args_nr.dl_channel_args      = args.phy.dl_channel_args; ///< Copy DL channel emulator arguments
